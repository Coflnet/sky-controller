...
// ProductType represents sum type.
...
func (s ProductType) IsString() bool { return s.Type == StringProductType }

// IsInt reports whether ProductType is int.
func (s ProductType) IsInt() bool { return s.Type == IntProductType }

// SetString sets ProductType to string.
func (s *ProductType) SetString(v string) {
	s.Type = StringProductType
	s.String = v
}
